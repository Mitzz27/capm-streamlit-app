...
# Setting Page Config
st.set_page_config(page_title="Stock_Analysis",
...
# Columns for fundamental data
col1, col2 = st.columns(2)

with col1:
    df = pd.DataFrame(index=["Market Cap", "Beta", "EPS", "PE Ratio"] )
    df[''] = [stock.info["marketCap"], stock.info["beta"], stock.info["trailingEps"],
...
if num_period == '':
    ...
    if chart_type =='Candel' and indicators == 'RSI':
    ...
    if chart_type =='Candel' and indicators == 'MACD':
        st.plotly_chart(candlestick(new_df1, num_period), use_container_width=True)
